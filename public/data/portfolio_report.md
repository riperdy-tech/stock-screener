...
| 10 | **ABNB** | 1.8 | B | 80.47 | 80 | 10 | research_now | - | no_data | 5 | - | - |
...
- EMBJ: sized below minimum (0.27% < 0.75%)
...
## Sizing method
- Quarter-Kelly: 6 positions — f = 0.25 x mu/sigma^2, mu = expectations-gap recovery over 3y (cap 15%), sigma floor 15%, position cap 5.0%.
