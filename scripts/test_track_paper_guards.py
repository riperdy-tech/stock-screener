...
# ── F-04 hysteresis: REMOVED in the depth migration (2026-08-26) ─────────────
# llm_hold_qualifies + the equal_llm retention band were dropped — the depth gate
# reads the frozen `direction` verdict, so there is no daily cliff to churn across
# and nothing for a hysteresis to protect. The rn_depth gate is covered by
# test_rn_depth_ledger.py; the depth veto by score_factors' apply_llm_overlay.
