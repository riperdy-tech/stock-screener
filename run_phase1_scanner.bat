@echo off
echo ===================================================
echo     PHASE 1 STOCK SCREENER (Decoupled Mode)
echo ===================================================
echo.
echo This script runs the Phase 1 Python screener independently.
...
set PYTHONHOME=
py -u scripts/fetch_phase1_screener.py --csv "public/data/stocks.csv"
